...
> {
  ...
  public readonly invoices: HasManyRepositoryFactory<Invoice, typeof Customer.prototype._id>;

  public readonly address: HasOneRepositoryFactory<Address, typeof Customer.prototype._id>;

  public readonly customerUser: HasOneRepositoryFactory<CustomerUser, typeof Customer.prototype._id>;

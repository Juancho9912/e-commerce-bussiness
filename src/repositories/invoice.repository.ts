...
export class InvoiceRepository extends DefaultCrudRepository<
  Invoice,
  typeof Invoice.prototype._id,
  InvoiceRelations
> {

  public readonly products: HasManyThroughRepositoryFactory<Product, typeof Product.prototype._id,
          ProductsInvoice,
          typeof Invoice.prototype._id
        >;

  public readonly customer: BelongsToAccessor<Customer, typeof Invoice.prototype._id>;
